...
% Ambiente para códigos UML que permite quebra de página
\mdfdefinestyle{umlcode}{
    leftmargin=0.3cm,
    rightmargin=0.3cm,
...
\newmdenv[style=umlcode]{umlcodebox}
...
\textbf{Alunos:} João Marcos, Sophia Lannah, Victor Gabriel \\
...
\textbf{Evidência:} Transcrição completa da entrevista disponível no Apêndice A (página \pageref{apendice-a})
...
\begin{figure}[H]
    \centering
    \adjustbox{max width=\textwidth,max height=0.8\textheight,center}{\includegraphics{assets/diagrama_casos_uso.png}}
...
\begin{figure}[H]
    \centering
    \adjustbox{max width=\textwidth,max height=0.8\textheight,center}{\includegraphics{assets/diagrama_classes.png}}
...
\begin{figure}[H]
    \centering
    \adjustbox{max width=\textwidth,max height=0.8\textheight,center}{\includegraphics{assets/diagrama_atividades.png}}
...
\begin{figure}[H]
    \centering
    \adjustbox{max width=\textwidth,max height=0.8\textheight,center}{\includegraphics{assets/diagrama_sequencia.png}}
...
\begin{figure}[H]
    \centering
    \adjustbox{max width=\textwidth,max height=0.8\textheight,center}{\includegraphics{assets/diagrama_estados.png}}
...
A rastreabilidade foi estabelecida conectando cada requisito aos seus artefatos relacionados através da matriz de rastreabilidade, garantindo que todos os requisitos estão conectados aos seus respectivos casos de uso, diagramas UML e implementações, facilitando a validação e a manutenção do sistema.
...
\begin{itemize}
    ...
    \item \textbf{Solução:} Criação de uma matriz de rastreabilidade detalhada permitiu estabelecer conexões claras entre todos os artefatos do projeto.
\end{itemize}
...
\begin{itemize}
    ...
    \item Os diagramas UML facilitaram significativamente a compreensão do sistema e ajudaram a identificar inconsistências antes da implementação.
    \item A rastreabilidade permitiu validar que todos os requisitos foram atendidos e facilita futuras manutenções do sistema.
    \item A organização em entregas parciais permitiu entregas incrementais e validação contínua.
...
\begin{center}
\textbf{Documento elaborado por:} João Marcos, Sophia Lannah, Victor Gabriel \\
\textbf{Data de conclusão:} 03/02/2026
\end{center}
